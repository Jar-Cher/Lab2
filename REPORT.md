...
## Вывод
Я ознакомился с жизненным циклом Activity. Он состоит из четырёх состояний: active, visible, stopped and destroyed. Я изучил основные возможности и свойства Alternate resourses, а также изучил принцип работы алгоритма для выбора best-matching resource. Кроме того, я исправил приложение-счётчик, используя свои базовые познания о работе потоков. Знание жизненного цикла приложений должно сильно помочь в моих грядущих работах.                                                                                                                                                                                                    
